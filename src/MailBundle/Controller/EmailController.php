...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('MailBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('MailBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('MailBundle\Form\EmailType', $email);
