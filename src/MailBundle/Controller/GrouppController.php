...
class GrouppController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groupps = $em->getRepository('MailBundle:Groupp')->findAll();

        return $this->render('groupp/index.html.twig', array(
            'groupps' => $groupps,
        ));
    }
    ...
    {
        $groupp = new Groupp();
        $form = $this->createForm('MailBundle\Form\GrouppType', $groupp);
        ...
        return $this->render('groupp/new.html.twig', array(
            'groupp' => $groupp,
    ...
    public function showAction(Groupp $groupp)
    {
        ...
        return $this->render('groupp/show.html.twig', array(
            'groupp' => $groupp,
    ...
    {
        $deleteForm = $this->createDeleteForm($groupp);
        $editForm = $this->createForm('MailBundle\Form\GrouppType', $groupp);
        ...
        return $this->render('groupp/edit.html.twig', array(
            'groupp' => $groupp,
