...
use MailBundle\Entity\Telephone;
...
class TelephoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $telephones = $em->getRepository('MailBundle:Telephone')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MailBundle\Form\TelephoneType', $telephone);
    ...
    {
        $deleteForm = $this->createDeleteForm($telephone);
        $editForm = $this->createForm('MailBundle\Form\TelephoneType', $telephone);
