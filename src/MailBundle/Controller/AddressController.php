...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('MailBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('MailBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('MailBundle\Form\AddressType', $address);
